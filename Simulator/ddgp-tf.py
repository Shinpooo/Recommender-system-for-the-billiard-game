...
class ActorNetwork(object):
    ...
    #     self.actor_target_model.save(name)

    # def load_model(self, name):
    #     self.actor_target_model.load(name)
...
class CriticNetwork(object):
    ...
    # def save_model(self, name):
    #     self.critic_target_model.save(name)

    # def load_model(self, name):
    #     self.critic_target_model.load(name)
...
def train(sess, env, args, actor, critic, actor_noise = None, load = True, plot_anim = False):
