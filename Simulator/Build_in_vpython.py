...
def SLIDING(ball,time_start,time_end):
	...
	print("At %.2f sec: pos = (%.2f,%.2f,%.2f), v = (%.2f,%.2f,%.2f), w = (%.2f,%.2f,%.2f), u = (%.2f,%.2f,%.2f)"
		%(time_start,ball_init[0].x,ball_init[0].y,ball_init[0].z,ball_init[1].x,ball_init[1].y,ball_init[1].z,ball_init[2].x,ball_init[2].y,ball_init[2].z,ball_init[3].x,ball_init[3].y,ball_init[3].z))
